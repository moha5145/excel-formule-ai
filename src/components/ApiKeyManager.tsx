...
export function ApiKeyManager({ onKeySaved }: { onKeySaved: (key: string) => void }) {
  ...
  return (
    <div className="flex flex-col gap-5 p-8 bg-card/50 backdrop-blur-md rounded-2xl border border-border shadow-xl max-w-md mx-auto mt-20 transition-all hover:shadow-primary/5 hover:border-primary/20">
      ...
      <div className="mt-1 space-y-3">
        <Input 
          ...
          className="bg-slate-900/50 border-slate-700/50 focus:border-primary/50 text-white h-11 rounded-xl"
        />
        <Button 
          onClick={handleSave} 
      ...
      {/* Bloc d'aide étape par étape */}
      <div className="mt-2 border-t border-slate-800/80 pt-4 flex flex-col gap-3">
